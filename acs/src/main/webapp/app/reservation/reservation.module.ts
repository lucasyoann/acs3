...
@NgModule({
    ...
    declarations:[ReservationComponent,ModalAjoutComponent,ArticleComponent,ModalConsultationReservationComponent],
    entryComponents:[ModalAjoutComponent, ModalConsultationReservationComponent],
